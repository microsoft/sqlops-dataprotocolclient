...
// NOTE : This is currently checked in instead of using @types/azdata because the types were updated
// in https://github.com/microsoft/sqlops-dataprotocolclient/pull/66 to correspond to some fixes made
// in ADS. These types aren't published to npm yet though and so until that happens checking in the
// azdata.d.ts here from https://github.com/microsoft/azuredatastudio/blob/fd8993134f36a0ea42b1af890102d4a2f83e565e/src/sql/azdata.d.ts
// (1.39.0) until the next release is out and the updated typings are published.
