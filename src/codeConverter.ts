...
export interface Ic2p {
	...
	asExecutionPlanOptions(planOptions: sqlops.ExecutionPlanOptions): sqlops.ExecutionPlanOptions;
...
function asExecutionPlanOptions(planOptions: sqlops.ExecutionPlanOptions): sqlops.ExecutionPlanOptions {
	return {
