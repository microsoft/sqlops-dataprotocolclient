...
(function (ChangePasswordRequest) {
    ChangePasswordRequest.type = new vscode_languageclient_1.RequestType('connection/changepassword');
...
var SaveResultsAsMarkdownRequest;
(function (SaveResultsAsMarkdownRequest) {
    SaveResultsAsMarkdownRequest.type = new vscode_languageclient_1.RequestType('query/saveMarkdown');
})(SaveResultsAsMarkdownRequest = exports.SaveResultsAsMarkdownRequest || (exports.SaveResultsAsMarkdownRequest = {}));
// --------------------------------- </ Save Results as Markdown Request > -----------------------------------------
